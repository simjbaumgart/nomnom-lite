...
from ..config import DEFAULT_CITY_ID
...
# Define permit status for major locations by city
LOCATION_PERMITS = {
    "copenhagen": {
    ...
    "ghent": {
        # Placeholder data for Ghent
        "Graslei": "RED",
        "Korenlei": "RED",
        "Gravensteen": "RED",
        "Saint Bavo's Cathedral": "YELLOW",
        "Belfry of Ghent": "YELLOW",
        "Vrijdagmarkt": "YELLOW",
        "Citadelpark": "GREEN",
        "Blaarmeersen": "GREEN",
        "Muinkpark": "GREEN",
...
def get_permit_status(location_name: str, city_id: str = DEFAULT_CITY_ID) -> dict:
    """Get permit status for a location in a specific city."""
    city_permits = LOCATION_PERMITS.get(city_id, {})
    status_code = city_permits.get(location_name, "YELLOW")  # Default to YELLOW if unknown
...
# Full permit regulations information by city
PERMIT_REGULATIONS = {
    "copenhagen": {
    ...
    "ghent": {
        "title": "Ghent Coffee Cart Permit Guide (Placeholder)",
        "sections": [
            {
                "heading": "Required Permits",
                "items": [
                    {
                        "title": "City of Ghent Permit",
                        "details": [
                            "Required for mobile street vending",
                            "Contact: Stad Gent - Dienst Economie",
                            "Processing time: Variable"
                        ]
                    },
                    {
                        "title": "FAVV Registration",
                        "details": [
                            "Federal Agency for the Safety of the Food Chain",
                            "Required for all food businesses"
                        ]
                    }
                ]
            }
        ],
        "disclaimer": "This is placeholder data for Ghent. Please consult local authorities for accurate regulations.",
        "application_url": "https://stad.gent/nl/ondernemen",
        "general_rules": [
            "Display permit visibly",
            "Keep area clean",
        ...
        "zones": {
            "green": {
                "locations": ["Citadelpark", "Blaarmeersen", "Muinkpark"],
                "requirements": "Generally allowed with standard permit.",
                "cost": "Consult city hall"
            },
            "yellow": {
                "locations": ["Vrijdagmarkt", "Saint Bavo's Cathedral"],
                "requirements": "Market days only or specific spots.",
                "cost": "Market fees apply"
            },
            "red": {
                "locations": ["Graslei", "Korenlei", "Gravensteen"],
                "requirements": "Highly restricted historic zone.",
                "cost": "Special event permits only"
            }
        }
    }
}
